...
\begin{table}[H]
  ...
  \begin{tabular}{|p{6cm}|p{4cm}|}
    \hline
    \textbf{Features 1-3 (Same Parameters Found): Best Parameters Found} & \textbf{Value} \\
    \hline
    C & 0.1 \\
    \hline
    penalty & l1 \\
    ...
    \hline
  \end{tabular}
  \caption{Best Parameters for Logistic Regression (Features 1-3)}
  \label{tab:feature3Params}
\end{table}
